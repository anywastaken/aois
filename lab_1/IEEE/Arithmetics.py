class Arithmetics:
    ...
    def __add__(self, other):
        ...
        if carry == 1:
            ...
            shift = 0
            while shift < 24 and m_res[shift] == 0:
                shift += 1
            if shift > 0:
        ...
        if exp_res >= 255:
            return CurrentClass([sign_res] + [1]*8 + [0]*23)
        if exp_res <= 0:
            return CurrentClass([sign_res] + [0]*8 + [0]*23)
    ...
    def _mul_arrays(self, a: list[int], b: list[int]) -> list[int]:
        """Умножает два 24-битных массива. Возвращает массив из 48 бит."""
        result = [0] * 48
    ...
    def __truediv__(self, other):
        ...
        # 3. Подготовка мантисс (24 бита: неявная 1 + 23 бита дроби)
        m1 = [1] + self.bits[9:]
        m2 = [1] + other.bits[9:]
        ...
        # 1 бит целой части + 24 бита дроби (с запасом для сдвига)
        for _ in range(25):
